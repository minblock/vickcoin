...
const char * const BITCOIN_CONF_FILENAME = "vickcoin.conf";
const char * const BITCOIN_PID_FILENAME = "vickcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Vickcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Vickcoin";
#else
    // Unix
    return pathRet / ".vickcoin";
#endif
#endif
}
