...
{
    const char* pszTimestamp = "4/2/2020 Provigen Networks: now accepting Incotermoshis";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1585981732, 1188672, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xbf84fd997dd6a6d8d1706346a4faaa8af6ddcd1522054da192f9235560f5cd69"));
        assert(genesis.hashMerkleRoot == uint256S("0xfccb35a3c1671b3aeb6a532e42c1371a03fea2f875ab8d796e78d01f5a55c6f5"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.vickcoin.loshan.co.uk", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("vickcointools.com", "dnsseed.vickcointools.com"));
        //vSeeds.push_back(CDNSSeedData("vickcoinpool.org", "dnsseed.vickcoinpool.org"));
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 1441182, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0cd92ef807e6aec8d04c48b76d05205fd9a2797330ebe9bcffc2c6b128b4f027"));
        assert(genesis.hashMerkleRoot == uint256S("0xfccb35a3c1671b3aeb6a532e42c1371a03fea2f875ab8d796e78d01f5a55c6f5"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        //vSeeds.push_back(CDNSSeedData("vickcointools.com", "testnet-seed.vickcointools.com"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.vickcoin.loshan.co.uk", true));
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x47202879082df6f9bb815cf23d258ee49b901415303b2cc091a29cef68205e4b"));
        assert(genesis.hashMerkleRoot == uint256S("0xfccb35a3c1671b3aeb6a532e42c1371a03fea2f875ab8d796e78d01f5a55c6f5"));
