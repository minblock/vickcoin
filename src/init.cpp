...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/vickcoin-project/vickcoin>";
    const std::string URL_WEBSITE = "<https://vickcoin.org>";
