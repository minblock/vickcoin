...
pkgdatadir = $(datadir)/vickcoin
pkgincludedir = $(includedir)/vickcoin
pkglibdir = $(libdir)/vickcoin
pkglibexecdir = $(libexecdir)/vickcoin
...
ACLOCAL = ${SHELL} /vickcoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /vickcoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /vickcoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /vickcoin/build-aux/missing automake-1.15
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = vickcoin-cli
BITCOIN_DAEMON_NAME = vickcoind
BITCOIN_GUI_NAME = vickcoin-qt
BITCOIN_TX_NAME = vickcoin-tx
...
COPYRIGHT_HOLDERS_FINAL = The Vickcoin Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = Vickcoin Core
COPYRIGHT_YEAR = 2017
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /vickcoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = vickcoin
PACKAGE_BUGREPORT = https://github.com/vickcoin-project/vickcoin/issues
PACKAGE_NAME = Vickcoin Core
PACKAGE_STRING = Vickcoin Core 0.14.2
PACKAGE_TARNAME = vickcoin
PACKAGE_URL = https://vickcoin.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /vickcoin
abs_srcdir = /vickcoin
abs_top_builddir = /vickcoin
abs_top_srcdir = /vickcoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /vickcoin/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/Vickcoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/Vickcoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Vickcoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Vickcoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
